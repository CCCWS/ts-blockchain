...
const searchAddressHandler = (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const GOOGLE_URL = `https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURI(userAddress)}&key=${GOOGLE_API}`;
    try {
        const res = yield axios__WEBPACK_IMPORTED_MODULE_0___default().get(GOOGLE_URL);
        if (res.status === 200) {
