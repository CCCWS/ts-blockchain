/// <reference path = "./Interface/DragInterface.ts" />
    ...
    var ProjectState = /** @class */ (function (_super) {
        ...
        function ProjectState() {
            ...
            _this.addProject = function (title, description, people) {
                var newProject = new App.ProjectType(String(new Date().getTime()), title, description, people, App.ProjectStatus.Active);
    ...
    var ProjectItem = /** @class */ (function (_super) {
        ...
        function ProjectItem(hostId, project) {
            ...
            _this.renderContent = function () {
                ...
                _this.element.querySelector("h2").textContent = "".concat(_this.project.title, " ").concat(_this.project.people.toString(), "\uBA85");
